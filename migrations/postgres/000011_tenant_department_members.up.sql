CREATE TABLE tenant_department_members (
    id text PRIMARY KEY, tenant_id text NOT NULL REFERENCES tenants(id), department_id text NOT NULL REFERENCES tenant_departments(id),
    membership_id text NOT NULL REFERENCES tenant_memberships(id), is_primary boolean NOT NULL DEFAULT false,

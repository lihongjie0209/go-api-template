CREATE TABLE platform_configs (id text PRIMARY KEY,config_key text NOT NULL,name text NOT NULL,category text NOT NULL DEFAULT '',value jsonb NOT NULL,description text NOT NULL DEFAULT '',is_public boolean NOT NULL DEFAULT false,status text NOT NULL CHECK(status IN('active','disabled')),created_at timestamptz NOT NULL,created_by text NOT NULL,updated_at timestamptz NOT NULL,updated_by text NOT NULL,version bigint NOT NULL CHECK(version>0),deleted_at timestamptz,deleted_by text);
